package com.princeli.vertx.webdemo.context;
 ...
 */
@Configuration
@EnableJpaRepositories(basePackages = {"com.princeli.vertx.webdemo.repository"})
@PropertySource(value = { "classpath:application.properties" })
@ComponentScan("com.princeli.vertx.webdemo")
public class SpringConfiguration {
  ...
  public LocalContainerEntityManagerFactoryBean entityManagerFactory(final DataSource dataSource) {
    ...
    factory.setPackagesToScan("com.princeli.vertx.webdemo.entity");
